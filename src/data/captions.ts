...
export const captions: Record<string, CaptionEntry> = {
  ...
  'IMG_20260503_191611_130.jpg': {
    ...
    caption: 'Two Porsche 911 Turbos (930) flank each other at the show — a black car in the foreground with its "Turbo 3.0" engine lid script, a silver whale-tail example behind it. Both are unmistakably from the era when Porsche\'s turbo earned the nickname "widow-maker."',
  },
  'IMG_20260503_191840_818.jpg': {
    title: 'McLaren Senna',
    caption: 'A McLaren Senna in metallic blue with carbon detailing and red brake callipers. Brutally functional aero, dihedral doors open — this is a car built without apology.',
  },
  'IMG_20260503_192032_018.jpg': {
    title: 'Bentley — Custom Wrap',
    caption: 'Someone took a Bentley, wrapped it in candy pink with a dark green diagonal stripe, swapped the winged B badge for a barista holding a coffee cup, and wrote "CAFFEINE BACK THERE" on the fuel flap. It works.',
  },
  'IMG_20260503_192220_007.jpg': {
    title: 'Ferrari F40',
    caption: 'Ferrari F40 in full, fronted up in Rosso Corsa under the show lights. The plate reads "40 RED." Appropriate.',
  },
  ...
  'IMG_20260503_234528_510.jpg': {
    title: 'BMW M1',
    caption: 'BMW M1 in white, wearing the full M-sport red, blue and dark-blue tricolour stripe the length of the car. Plate "H1 MZ6." One of the rarest road cars BMW ever made.',
  },
  ...
  'IMG_20260503_235252_421.jpg': {
    ...
    caption: 'A silver early-generation Porsche 911 and a yellow Alfa Romeo Giulia GT share a frame at the show. An unlikely pairing that somehow makes perfect sense.',
  },
  ...
  'IMG_20260504_002654_112.jpg': {
    ...
    caption: 'The rear of a silver Porsche 930 Turbo, whale-tail spoiler, "turbo" script on the engine lid and "PORSCHE" in red across the tail panel. An icon viewed from its best angle.',
  },
  'IMG_20260504_003126_589.webp': {
    title: 'Pagani Zonda — Diffuser Detail',
    caption: 'Close-up of the Pagani Zonda\'s rear diffuser and exhaust arrangement. The chrome "Zonda" script sits above the carbon-fibre mesh, blue iridescent paint glowing behind it. A fitting full stop to a remarkable car.',
  },
  ...
  'DSC_4855-Enhanced-NR.jpg': {
    ...
    caption: 'Cadillac V-Series.R, car #38, sits in the Cadillac Racing pit under the Le Mans floodlights. Army green and gold, the Hertz branding prominent, crew in matching dark green. The night shift is well underway.',
  },
  ...
  'DSC_4881-Enhanced-NR.jpg': {
    ...
    caption: 'Ford Mustang GT3, car #88, in the Ford Racing pit. Blue livery under the "88" gantry sign. The pony car takes on the world\'s greatest endurance race.',
  },
  ...
  'DSC_4910-Enhanced-NR.jpg': {
    ...
    caption: 'The Heart of Racing\'s Aston Martin Vantage GT3 #23 (left) and Valkyrie AMR Pro #009 (right) in adjacent pit bays. Two very different Aston Martins, both in the thick of it at Le Mans 2025.',
  },
  'DSC_4912-Enhanced-NR.jpg': {
    title: 'Aston Martin Valkyrie #009 & #007 — Le Mans 2025',
    caption: 'Aston Martin Valkyrie AMR Pro cars #009 and #007 side by side in the Thor Team pit. Dark green, gold details, the Valkyrie\'s sweeping bodywork unmistakable even under artificial light.',
  },
  ...
  'DSC_4924-Enhanced-NR.jpg': {
    ...
    caption: 'Double occupancy in the Aston Martin Thor Team pit: #009 in the foreground, #007 behind. The full hypercar programme, together under the floodlights.',
  },
  ...
  'DSC_4933-Enhanced-NR.jpg': {
    ...
    caption: 'United Autosports #22 from a wider angle, Manthey Racing\'s bay clearly visible to the left. Pit lane life between stints.',
  },
